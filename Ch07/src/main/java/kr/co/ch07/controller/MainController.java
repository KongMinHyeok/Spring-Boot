...
public class MainController {
	...
	public String query1() {
		User1VO user = repo.findUser1VOByUid("a103");
	...
	public String query4() {
		List<User1VO> users = repo.findUser1VOByUidAndName("a104", "김유신");
	...
	public String query5() {
		List<User1VO> users = repo.findUser1VOByUidOrName("a105", "김유신");
	...
	public String query6() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThan(27);
